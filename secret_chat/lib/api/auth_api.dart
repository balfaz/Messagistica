  ...
  Future<bool> register(BuildContext context,
    ...
    try {
      ...
      if (response.statusCode == 200) {
        final String token = parsed['token'].toString();
        final int expired = parsed['expiresIn'] as int;
        // save token
        await _registerToken(token);
        await _session.set(token, expired);
    ...
    try {
      ...
      if (result != null) {
        ...
        if (newData != null) {
          ...
          final newExpire = newData['expiresIn'];
          await _session.set(newToken, newExpire);
          return newToken;
        }
      }
    } on PlatformException catch (e) {
